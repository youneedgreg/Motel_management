...
const CheckedOutGuestList = () => {
  ...
  // Filter guests to show only those with status "checked-out"
  const checkedOutGuests = guests.filter(guest => guest.status === "checked-out");
...
export default CheckedOutGuestList;
